...
- **Context Management:** Uses server-side compaction when supported and local summarization otherwise, with warnings as conversations approach the context limit.
...
- **`model`**: Choose the Claude model (default: Claude Opus 5).
