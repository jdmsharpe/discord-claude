...
class AnthropicAPI(commands.Cog):
    ...
    @option(
        ...
        choices=[
            ...
            OptionChoice(name="Claude Haiku 3.5", value="claude-haiku-3-5"),
            OptionChoice(name="Claude 3.5 Sonnet", value="claude-3-5-sonnet"),
            OptionChoice(name="Claude 3.5 Haiku", value="claude-3-5-haiku"),
            OptionChoice(name="Claude 3 Opus", value="claude-3-opus"),
            OptionChoice(name="Claude 3 Sonnet", value="claude-3-sonnet"),
            OptionChoice(name="Claude 3 Haiku", value="claude-3-haiku"),
        ],
        type=str,
    )
    @option(
